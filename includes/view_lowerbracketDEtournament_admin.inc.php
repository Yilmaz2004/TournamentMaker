...
$selectnameSql = 'SELECT name FROM tournaments WHERE tournaments.tournament_id = :tournament_id';
...
<br>
<button class="btUpperbracket" onclick="location.href='index.php?page=view_upperbracketDEtournament_admin&tournament_id=<?php echo $tournament_id ?>;'">Upperbracket</button>
<br>
